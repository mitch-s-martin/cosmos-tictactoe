...
import AliceTictactoeAliceTictactoeTictactoe from './alice/tictactoe/alice.tictactoe.tictactoe'
...
export default { 
  AliceTictactoeAliceTictactoeTictactoe: load(AliceTictactoeAliceTictactoeTictactoe, 'alice.tictactoe.tictactoe'),
