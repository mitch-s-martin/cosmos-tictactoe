...
export interface TictactoeNextGame {
  /** @format uint64 */
  idValue?: string;
}
...
export interface TictactoeQueryGetNextGameResponse {
  NextGame?: TictactoeNextGame;
}
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/alice/tictactoe/tictactoe/next_game
   */
  queryNextGame = (params: RequestParams = {}) =>
    this.request<TictactoeQueryGetNextGameResponse, RpcStatus>({
      path: `/alice/tictactoe/tictactoe/next_game`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/alice/tictactoe/tictactoe/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<TictactoeQueryParamsResponse, RpcStatus>({
      path: `/alice/tictactoe/tictactoe/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/alice/tictactoe/tictactoe/stored_game
   */
  queryStoredGameAll = (
    query?: {
    ...
    this.request<TictactoeQueryAllStoredGameResponse, RpcStatus>({
      path: `/alice/tictactoe/tictactoe/stored_game`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
